...
public class ProductCont {
	...
	@PostMapping("/insert")
	public String insert(@RequestParam Map<String, Object> map, //map안에 파일을 넣을 수 있지만 형변환의 번거로움이 있어서
						 @RequestParam MultipartFile img,
						 HttpServletRequest req) {		//하단과 같이 별도로 지정함
		//매개변수가 Map이면 name이 key로 저장된다
		//예)<input type="text" name="price_name">
	...
	*/
	...
	/*
		//http://localhost:9095/product/detail?product_code=42
		@GetMapping("/detail")
		public ModelAndView detail(@RequestParam int product_name) {}//detail() end
	*/
	
	//http://localhost:9095/product/detail/42
	@GetMapping("/detail/{product_code}") /*{product_code}변수에 42전달*/
	...
	@PostMapping("/update")
	public String update(@RequestParam Map<String, Object> map, //map안에 파일을 넣을 수 있지만 형변환의 번거로움이 있어서
						 @RequestParam MultipartFile img,
